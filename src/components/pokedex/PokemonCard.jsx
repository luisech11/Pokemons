...
const PokemonCard = ({ pokemonUrl }) => {
  ...
  return (
    <Link
      ...
      } rounded-md transform hover:scale-105 transition-transform duration-300 ease-in-out`}
    >
      <header
      ...
      >
        {pokemonInfo?.image ? (
          <div className="absolute left-1/2 -translate-x-1/2 -bottom-5 h-[70px] aspect-square transform hover:scale-110 transition-transform duration-300 ease-in-out">
            <img
          ...
          <div className="absolute left-1/2 -translate-x-1/2 -bottom-10 h-[100px] aspect-square transform hover:scale-110 transition-transform duration-300 ease-in-out">
            <img
              className="h-full w-full object-contain"
